      ...
      children: [
        for (final filter in filters)
          AppFilterChip(
            ...
            onTap: filter['label'] == 'Filter' ? _showFilterBottomSheet : null,
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 3. Floating Back Button (hidden while sticky search is pinned)
          if (!_showStickySearch)
            Positioned(
              top: topInset + 12,
              left: 16,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isNotAccepting ? const Color(0xFFA59A94) : null,
                ...
                boxShadow: isNotAccepting
                    ...
                    : [
                        BoxShadow(
                          color:
                              const Color(0xFFFF5E00).withValues(alpha: 0.35),
                          blurRadius: 10,
                          offset: const Offset(0, 4),
                        ),
                      ],
