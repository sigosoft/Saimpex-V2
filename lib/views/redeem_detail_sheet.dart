...
class RedeemDetailSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final progress =
        ((reward['progress'] as num?)?.toDouble() ?? 0.6).clamp(0.0, 1.0);
    ...
    // Same Stack pattern as food detail: close floats above sheet with a gap.
    const closeGap = 12.0;
    final sheetHeight = screenH * 0.85;

    return SizedBox(
      height: sheetHeight + _closeSize + closeGap,
      child: Stack(
        clipBehavior: Clip.none,
        ...
        children: [
          ...
          // Close — centered above sheet top edge with gap (matches food detail)
          Positioned(
            top: 0,
            left: 0,
            right: 0,
