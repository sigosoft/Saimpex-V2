...
class PharmacyTrackOrderScreen extends StatefulWidget {
  final String orderId;
  final String merchantName;

  const PharmacyTrackOrderScreen({
    super.key,
    this.orderId = '#22789002',
    this.merchantName = 'Pharmacy Nasr',
  });

  @override
  State<PharmacyTrackOrderScreen> createState() =>
      _PharmacyTrackOrderScreenState();
}

class _PharmacyTrackOrderScreenState extends State<PharmacyTrackOrderScreen> {
  GoogleMapController? _mapController;

  final LatLng pharmacyLoc = const LatLng(18.0836, -15.9802);
...
''';
    ...
    setState(() {
      _polylines = {
        Polyline(
          ...
          points: _curvedRoute(pharmacyLoc, riderLoc, homeLoc),
  ...
  Future<void> _updateMarkerScreens() async {
    ...
    try {
      ...
      final store = await controller.getScreenCoordinate(pharmacyLoc);
  ...
  Widget build(BuildContext context) {
    ...
    final displayId = widget.orderId.startsWith('#')
        ? widget.orderId
        : '#${widget.orderId}';
        ...
        children: [
          Positioned.fill(
            child: GoogleMap(
              ...
              padding: EdgeInsets.only(bottom: 280 + bottomPad, top: 8),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Order $displayId • ${widget.merchantName}',
                    style: GoogleFonts.outfit(
  ...
  Widget _buildProgressTracker() {
    const steps = [
      _TrackStep(
        label: 'Order placed',
        time: '22 Oct 2025, 10:00 AM',
        done: true,
        icon: Icons.check_rounded,
      ),
      _TrackStep(
        label: 'Preparing',
        time: '22 Oct 2025, 10:05 AM',
        done: true,
        icon: Icons.assignment_outlined,
      ),
      _TrackStep(
        label: 'On the way',
        time: '22 Oct 2025, 10:10 AM',
        done: true,
        icon: Icons.delivery_dining_rounded,
      ),
      _TrackStep(
